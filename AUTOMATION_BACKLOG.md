...
- **2026-08-20** `git rebase master` conflicts in `GAPS.md`. Needs human resolution before
  any further automated work can proceed. Conflict persists since 2026-08-19.
