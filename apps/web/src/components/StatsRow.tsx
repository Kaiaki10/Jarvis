...
function Stat({
  ...
  label: string;
  /** Animated. The part of the value that actually moves. */
  count: number;
  /** Static trailing text, e.g. the "/4" in "3/4". */
  suffix?: string;
  ...
  return (
    <Spotlight className="h-full">
      <Card className="relative h-full overflow-hidden px-4 py-4">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-0.5 text-title text-2xl leading-tight text-foreground">
              <CountUp value={count} />
              {suffix}
            </div>
          </div>
...
export function StatsRow() {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 xl:grid-cols-4">
      ...
      />
      <Stat icon={Circle} label="Runs today" count={sessionsToday} />
      <Stat
        icon={CalendarClock}
        label="Automations"
